...
> When a user signs up, the backend sends a verification email automatically. To enable real email delivery, configure SMTP values in `backend/.env`.
...
passwords Admin	admin@sportsman.ke	admin123	/admin
Warehouse Staff	warehouse@sportsman.ke	warehouse123	/warehouse
Delivery Agent	delivery@sportsman.ke	delivery123	/delivery
Customer	customer@sportsman.ke	customer123